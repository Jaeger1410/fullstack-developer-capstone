            ...
            <div>
                ...
                <select style={{ marginLeft: '10px', marginRight: '10px', paddingLeft: '10px', borderRadius: '10px'}} name="model" onChange={SearchCarsByModel}>
                    {models.length === 0 ? (
                        ...
                        <>
                            <option disabled deafultValue> -- All -- </option>
                ...
                <span style={{ marginBottom: '10px', padingLeft: '10px'}}>Year</span>
                ...
                <select style={{ marginLeft: '10px', marginRight: '10px', paddingLeft: '10px', borderRadius: '10px'}} name="mileage" id="mileage" onChange={SearchCarsByMilage}>
                    <option selected value='all'> -- All -- </option>
